...
def generate_caption(predictCategories):
    ...
    # 질문 입력 및 처리
    question = f"This image contains {predictCategories[0]}, {predictCategories[1]}, and {predictCategories[2]}. Please describe the image focusing on these objects and the overall scene."
